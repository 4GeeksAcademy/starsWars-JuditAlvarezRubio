...
import { getPeople, getVehicles, getPlanets, } from "../store/appContext"
          ...
          <Carousel.Item key={i}>
            <Card className="small-card">
              ...
              <Card.Body>
                ...
                <Button variant="primary" onClick={() => addToFavoritesCharacters(person)}>
                  Add to Favorites
                </Button>
              </Card.Body>
            </Card>
          ...
          <Carousel.Item key={i}>
            <Card className="small-card">
              <Card.Img
                ...
                <Button variant="primary" onClick={() => addToFavoritesVehicles(vehicle)}>
                  Add to Favorites
                </Button>
              </Card.Body>
              </Card>
      ...
      <Carousel>
        {planets.map((planet, i) => (
          <Carousel.Item key={i}>
            ...
            <Button  variant="primary" onClick={() => addToFavoritesPlanets(planet)}>
                  Add to Favorites
                </Button>
            </Card.Body>
            </Card>
