            ...
            <Col xs={12}>
              <Card className="shadow">
                <Row noGutters>
                  ...
                  <Col xs={12} md={6}>
                    <Card.Body>
                      <Card.Title className="text-center mb-4">{character.name}</Card.Title>
                      <Card.Text>
                        <p>Lorem ipsum dolor sit amet. Est omnis maxime ex quia ullam ut provident
                          ...
                          rerum blanditiis ut voluptatem nulla et culpa nostrum sed labore reprehenderit.</p>
                      </Card.Text>
                      <Row className="mt-3">
                        <Col xs={12}>
